/**
 * Response utils borrowed from partykit-nextjs-chat-template
 *      Original: https://github.com/partykit/partykit-nextjs-chat-template/blob/main/party/utils/response.ts
 */
